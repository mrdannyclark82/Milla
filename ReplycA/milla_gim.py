url: https://raw.githubusercontent.com/mrdannyclark82/ReplycA/e007aa1a2af5dd5c3c0b5f785c95d0abb115adb6/milla_gim.py
...
def get_self_state():
    ...
    for f_path in files_to_check:
        fu
ll_path = os.path.join(PROJECT_ROOT, f_path)
