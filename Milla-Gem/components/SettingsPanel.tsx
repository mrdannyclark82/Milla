url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/SettingsPanel.tsx
...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  return (
    <div className="absolute top-12 right-0 w-80 bg-background-light dark:bg-gray-800 rounded-lg shadow-xl border border-black/10 dark:border-white/10 p-4 flex flex-col gap-4 z-10">
      ...
      <div>
        <h
3 className="text-sm font-semibold mb-2 text-gray-800 dark:text-gray-200">Options</h3>
...
>
      ...
      <div>
        ...
        <textarea
          ...
          rows={5}
          className="w-full bg-gray-200 dark:bg-gray-700 border-transparent rounded
-lg text-xs text-gray-800 dark:text-gray-200 focus:ring-primary focus:border-primary placeholder-gray-500"
