url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/InputBar.tsx
      ...
      <form onSubmit={handleSubmit} className="relative">
        ...
        <div className="absolute inset-y-0 left-0 flex items-center pl-3">
            <button
                ...
                disabled={isLoading || isLive}
                className="p-2 text-
gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary disabled:opacity-50 disabled:cursor-not-allowed"
            >
