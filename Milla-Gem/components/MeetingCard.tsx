url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/MeetingCard.tsx
...
export const MeetingCard: React.FC<{ toolCall: ToolCall }> = ({ toolCall }) => {
  ...
  const cardColorClass = isDraft
    ? 'bg-blue-50 dark
:bg-gray-800 border-blue-200 dark:border-gray-700'
