url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/NewsCard.tsx
  ...
  if (!news || !news.articles || news.articles.length === 0) {
    return (
        <div className="mt-2 p-3 rounded-lg w-full max-w-sm md:max-w-md border bg-green-50 dark:bg-gray-800 border-green-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-600 dark:tex
t-gray-400">No headlines found for this topic.</p>
        </div>
    );
  }
