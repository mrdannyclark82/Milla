url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/StockCard.tsx
...
export const StockCard: React.FC<{ toolCall: ToolCall }> = ({ toolCall }) => {
  ...
  const handleRefresh = async () => {
    ...
    try {
      const newResult = 
await executeTool('get_stock_price', args);
      setResult(newResult);
    } catch (e) {
    ...
    <div className="mt-2 p-3 rounded-lg w-full max-w-sm md:max-w-md border bg-green-50 dark:bg-gray-800 border-green-200 dark:border-gray-700">
        <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
             ...
             <button onClick={handleRefresh} disabled={i
sRefreshing} className="p-1.5 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 disabled:opacity-50">
