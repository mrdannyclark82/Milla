url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/NowPlayingCard.tsx
  ...
  return (
    <div className={`mt-2 p-3 rounded-lg w-full max-w-sm md:max-w-md border ${cardColorClass}`}>
        <div className="flex items-center gap-4">
            <img src={albumArt} alt="Album art" className="h-20 w-20 rounded-md obje
ct-cover" />
