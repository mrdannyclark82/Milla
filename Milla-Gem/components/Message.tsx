url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/components/Message.tsx
...
const CodeBlock: React.FC<{ code: string }> = ({ code }) => {
  ...
  return (
    <div className="relative my-2">
      ...
      >
        {isCopied ? <CheckIcon className="h
-4 w-4 text-green-400" /> : <CopyIcon className="h-4 w-4" />}
      </button>
    </div>
  );
};
