url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/services/geminiService.ts
...
const toolDeclarations: FunctionDeclaration[] = [
  ...
  },
  {
    ...
    parameters: {
        type: Type.OBJECT,
        properties: 
{ item: { type: Type.STRING, description: 'The to-do item to remove.' } },
        required: ['item']
    }
  },
  {
...
['date_range']
  ...
  },
  {
    ...
    parameters: {
        ...
        properties: {
            destination: { type:
 Type.STRING, description: 'The destination city.' },
