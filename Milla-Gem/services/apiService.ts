url: https://raw.githubusercontent.com/mrdannyclark82/Milla-Gem/00b4fc6539267fe8d29b65b188e1ad9d094cbacc/services/apiService.ts
...
export const executeTool = async (name: string, args: any, isDraft: boolean = false): Promise<any> => {
  ...
  switch (name) {
    ...
    case 'schedule_meeting':
      ...
      const minutes = timeMatch && timeMatch[2] ? parseInt(timeMatch[2], 10) : 
0;
