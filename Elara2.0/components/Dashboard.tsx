url: https://raw.githubusercontent.com/mrdannyclark82/Elara2.0/b1d507e0c56254cfa45cf76c4fa0cfeceb825e31/components/Dashboard.tsx
...
ht="100%">
          ...
          <div className="p-4 border-b border-slate-700 flex-shrink-0">
              ...
              <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-slate-800 p-1.5 rounded border border-slate-600 flex items-center gap-2">
                      <i className="fas fa-image text-pink-400 text-xs"></i> <spa
n className="text-[10px] text-slate-300">Imagen</span>
                  </div>
              </div>
          </div>
...
ft-[5px] top-2 w-2.5 h-2.5 rounded-full ${
...
ts.topTags.length > 0 && (
          ...
          <div className="space-y-1.5">
            ...
            <button 
              ...
              classNam
e="w-full py-1.5 bg-green-900/10 hover:bg-green-900/30 text-green-400 border border-green-900/30 rounded flex items-center justify-center gap-2 text-[10px] transition-colors"
            >
