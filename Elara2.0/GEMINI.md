url: https://raw.githubusercontent.com/mrdannyclark82/Elara2.0/b1d507e0c56254cfa45cf76c4fa0cfeceb825e31/GEMINI.md
...
*   Styling 
is done using Tailwind CSS (inferred from class names like `h-screen`, `w-screen`, `flex`, etc., although not explicitly in `package.json`, the class names are a strong indicator).
