url: https://raw.githubusercontent.com/mrdannyclark82/Elara2.0/b1d507e0c56254cfa45cf76c4fa0cfeceb825e31/services/memoryDatabase.ts
...
eNames.contains('embeddings')) {
  ...
  async saveUserProfile(profile: UserProfile): Promis
e<void> {
    if (!this.db) throw new Error('Database not initialized');
  ...
  async getMemoryStats(): Promise<{
    ...
    // Top 10 tags
    stats.topTags = Array.from(tagCount
s.entries())
  ...
  async importMemories(jso
nData: string): Promise<void> {
